...
uint8_t e28_get_rx_state(e28_manage_obj_t* e28_obj)
{	
...
static uint8_t e28_parm_write(e28_manage_obj_t* e28_obj)
{
	...
	e28_delayms(100);
	while(e28_get_rx_state(e28_obj) != 1 || e28_obj->rx_len != sizeof(e28_obj->e28_parm_pack) || u8buf_compare(e28_obj->rx_buf,(uint8_t*)&e28_obj->e28_parm_pack,sizeof(e28_obj->e28_parm_pack)) != 1)
	{
		e28_obj->uart_send_f((uint8_t*)&e28_obj->e28_parm_pack,sizeof(e28_obj->e28_parm_pack));
		e28_delayms(100);
		time_out ++;
...
uint8_t get_e28_fsm_curstate(e28_manage_obj_t* e28)
{
	return e28->fsm.curState;
}
...
uint8_t get_e28_aux(void)
{
	return HAL_GPIO_ReadPin(E28_AUX_GPIO_Port,E28_AUX_Pin);
}
